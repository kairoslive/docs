...
<Info>
  All Agora API calls require an `Authorization: Bearer <your-api-key>` header. Contact the Kairos team to enable Agora access on your account. Base URL: `https://agora.kairos.trade`.
</Info>
