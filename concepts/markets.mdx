...
Grids can have several bands: Kalshi markets tick at `0.001` below `0.04` and above `0.96`, and `0.01` in between. Read `ranges`, not a single tick size, and treat the values as decimals rather than floats.
